...
import styles from './product-comparison-styles';
...
class ProductComparisonView extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <Typography variant="h6" style = {{margin: '20px auto'}} align="center" className={'tableTitle'}>
        COMMON INGREDIENTS IN
      </Typography>

        <Grid container spacing={8}>
          <Grid item>
            <CardMedia style = {{ height: 120, width: 60 }}
...
ProductComparisonView.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(ProductComparisonView);
